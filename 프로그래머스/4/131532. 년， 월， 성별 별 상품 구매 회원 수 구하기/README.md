...
<p><code>USER_INFO</code> 테이블과 <code>ONLINE_SALE</code> 테이블에서 <web-highlight class="webhighlights-highlight" data-highlight-id="145b8ea1-6b02-400e-b107-325488d32378" data-highlight-split-type="both" data-highlight-id-extra="" markid="679da7388d1a846a426d167b" media-type="blockquote" style="background-color: rgb(253, 255, 180); color: rgb(0, 0, 0); cursor: pointer;">년, 월, 성별 별로 상품을 구매한 회원수</web-highlight>를 집계하는 SQL문을 작성해주세요. 결과는 년, 월, 성별을 기준으로 오름차순 정렬해주세요. 이때, 성별 정보가 없는 경우 결과에서 제외해주세요.</p>
